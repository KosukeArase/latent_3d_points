...
def main():
    ...
    conf = get_conf(class_name, params)
    ...
    all_pc_data = load_all_point_clouds_under_folder(train_dir, class_name, n_threads=20, n_points=conf.n_input[0], with_color=conf.input_color, verbose=True)
