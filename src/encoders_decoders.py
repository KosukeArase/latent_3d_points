...
def embedder_with_convs_and_symmetry(in_signal, n_filters=[64, 128, 256, 1024], filter_sizes=[1], strides=[1],
    ...
    '''An Embedder (embedding network), which maps visible points onto a latent space.
    '''
